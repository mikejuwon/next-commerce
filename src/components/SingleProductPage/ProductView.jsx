      ...
      >
        ...
        >
          <div className="w-full">
            <div className="w-full md:h-[600px] h-[350px] border border-qpurplelow flex justify-center items-center overflow-hidden relative mb-3 relative rounded">
              <Image
                layout="fill"
            ...
            <div className="flex gap-2 flex-wrap">
              <div
                ...
                className="w-[110px] h-[110px] p-[15px] border border-qpurplelow cursor-pointer relative rounded"
              >
                <Image
                  layout="fill"
                  objectFit="scale-down"
        ...
        <div className="flex-1">
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            <div className="w-full h-[1px] bg-qpurplelow mb-[30px]"></div>
            <div className="p-3 bg-qpurplelow flex items-center space-x-2 mb-[30px] rounded-lg w-fit">
            ...
            >
              <div className="w-[120px] h-full px-[26px] flex items-center border border-qpurplelow rounded-md">
                <div className="flex justify-between items-center w-full">
                  <button
                    onClick={decrement}
                    type="button"
              ...
              <div className="w-[60px] h-full flex justify-center items-center border border-qpurplelow rounded-md">
                {!arWishlist ? (
                  <button
                    type="button"
              ...
              <div className="flex-1 h-full">
                <button
                  onClick={addToCard}
                  type="button"
                  className="bg-qpurple hover:bg-qpurplelow hover:text-qpurple border border-transparent hover:border-qpurple transition-common text-white rounded-full text-sm font-semibold w-full h-full"
                >
