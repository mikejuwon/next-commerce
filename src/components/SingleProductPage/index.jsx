  ...
  return (
    <>
      <Layout childrenClasses="pt-0 pb-0">
        <>
          <div className="single-product-wrapper w-full bg-white">
            ...
            <div
              className={`product-des-wrapper w-full relative pt-[45px]  bg-[#F9EDF7] ${
                  ...
                  <ul className="flex space-x-5 ">
                    <li>
                      <span
                        ...
                        onClick={() => setTab("des")}
                        className={`py-[15px] sm:text-[15px] text-sm block px-6 font-medium cursor-pointer relative z-10 ${
                          tab === "des" ? "bg-qpurple text-white" : "text-qgray"
                        }`}
                      >
                    ...
                    {Multivendor() === 1 && details.is_seller_product && (
                      <li>
                        ...
                        >
                          {langCntnt && langCntnt.Seller_Info}
                        </span>
                      </li>
                    )}
                  </ul>
              ...
              >
                <div className="title-bar flex items-center justify-between mb-3">
                  <h6 className="text-2xl font-medium">
                    {langCntnt && langCntnt.Report_Products}
                  </h6>
                  <span
                ...
                <div className="inputs w-full">
                  ...
                  <div className="w-full mb-[40px]">
                    ...
                    <textarea
                      ...
                      className={`w-full focus:ring-0 rounded focus:outline-none py-3 px-4 border  placeholder:text-sm text-sm ${
                        reportErrors ? "border-qred" : "border-qpurplelow"
                      }`}
                  ...
                  >
                    <span>{langCntnt && langCntnt.Submit_Report}</span>
                    {reportLoading && (
                      <span
                        className="w-5 "
