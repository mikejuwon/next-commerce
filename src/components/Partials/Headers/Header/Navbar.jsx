              ...
              <div className="category rounded-t-md mt-[6px] relative">
                ...
                >
                  <div className="flex space-x-3 items-center">
                    <span className="inline-block text-white flex justify-center items-center w-[48px] h-[48px] bg-[#C459B5] rounded-full">
                      <svg
                        width="14"
                        height="9"
                        viewBox="0 0 14 9"
                ...
                <div
                  ...
                  className={`category-dropdown  w-[270px] absolute left-0 top-[56px]  ${
