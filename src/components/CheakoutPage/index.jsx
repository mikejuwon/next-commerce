          ...
          <div className="container-x mx-auto ">
            <div className="w-full lg:flex lg:space-x-[30px]">
                ...
                {!newAddress && (
                  <div className="addresses-widget w-full">
                    <div className="sm:flex justify-between items-center w-full mb-5">
                      <div className="bg-qpurplelow border border-qpurple rounded p-2">
                        <button
                    ...
                    <div className="form-area bg-[#F8F8F8] md:p-[40px] p-2.5">
                      <form>
                        ...
                        <div className="mb-6">
                          ...
                          <div
                            className={`w-full h-[50px] bg-white border px-5 flex justify-between items-center border-qpurplelow rounded mb-2 ${
              ...
              <div className="flex-1">
                ...
                <div className="w-full px-10 py-[30px] rounded border border-qpurplelow">
                  <div className="sub-total mb-6">
                    ...
                    <div className="w-full h-[1px] bg-qpurplelow"></div>
                  </div>
                        ...
                        >
                          <div className="stripe-inputs">
                            ...
                            <button
                              ...
                              className="w-full"
                            >
                              <div className="w-full h-[50px] rounded transition-common bg-qpurple hover:bg-qpurplelow hover:text-qpurple text-white flex justify-center items-center">
                                <span className="text-sm font-semibold">
                  ...
                  >
                    <div className="w-full h-[50px] flex justify-center items-center">
                      <div className="transition-common bg-qpurple hover:bg-qpurplelow hover:text-qpurple border border-transparent hover:border-qpurple text-white w-full h-full flex justify-center items-center rounded">
                        <span className="text-sm font-semibold">
                          {langCntnt && langCntnt.Place_Order_Now}
                        </span>
                      </div>
