...
export default function ProductsFilter({
  ...
  return (
    <>
      ...
      >
        <div className="filter-subject-item pb-10 border-b border-qborder">
          <div className="subject-title mb-[30px]">
            <h1 className="text-qblack text-base font-500">
              Product categories
            </h1>
          </div>
        ...
        <div className="filter-subject-item pb-10 border-b border-qborder mt-10">
          <div className="subject-title mb-[30px]">
            <h1 className="text-qblack text-base font-500">Price Range</h1>
          </div>
        ...
        <div className="filter-subject-item pb-10 border-b border-qborder mt-10">
          <div className="subject-title mb-[30px]">
            <h1 className="text-qblack text-base font-500">Brands</h1>
          </div>
          <div className="filter-items">
            <ul>
              <li className="item flex justify-between items-center mb-5">
        ...
        <div className="filter-subject-item pb-10 border-b border-qborder mt-10">
          <div className="subject-title mb-[30px]">
            <h1 className="text-qblack text-base font-500">Storage</h1>
          </div>
          <div className="filter-items">
            <div className="flex space-x-[5px] flex-wrap">
              <span
                onClick={() => filterstorage("64GB")}
                className={` font-400 border border-qborder text-xs px-[14px] py-[6px] cursor-pointer mb-[5px] ${
                  storage === "64GB"
                    ? "bg-qpurple text-qblack border-none"
                    : " text-qgray "
                }`}
              >
                64GB
        ...
        <div className="filter-subject-item pb-10 mt-10">
          <div className="subject-title mb-[30px]">
            <h1 className="text-qblack text-base font-500">Sizes</h1>
          </div>
          <div className="filter-items">
            <ul>
              <li className="item flex justify-between items-center mb-5">
