      ...
      <Layout>
        <div className="products-page-wrapper w-full">
          <div className="container-x mx-auto">
            ...
            >
              <div className="store-status w-[230px] h-[60px] bg-qpurple flex justify-end items-center rounded-full absolute top-[30px] -left-[30px]">
                <span className="text-[26px] font-600 mr-[30px]">
                  {langCntnt && langCntnt.Store_Open}
                </span>
              </div>
