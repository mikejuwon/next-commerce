    ...
    >
      <div className="flex flex-col h-full justify-between">
        ...
        <div className="">
          <div
            ...
            className="w-[135px] h-[48px] pl-6 pt-3 cursor-pointer  bg-qpurplelow group-hover:bg-qpurple transition-all duration-300 absolute -bottom-1 -right-1 ease-in-out"
          >
      ...
      <div className="quick-access-btn">
        <button
          ...
          type="button"
        >
          <span className="w-10 h-10 flex justify-center text-qblack hover:text-white items-center transition-all duration-300 ease-in-out hover:bg-qpurple bg-qpurplelow rounded-full">
        ...
        {!arWishlist ? (
          ...
          >
            <span className="w-10 h-10 flex text-qblack hover:text-white justify-center items-center transition-all duration-300 ease-in-out hover:bg-qpurple bg-qpurplelow rounded-full">
          ...
          >
            <span className="w-10 h-10 flex justify-center items-center bg-qpurplelow rounded-full">
              <ThinLove fill={true} />
            </span>
          </button>
        )}
        ...
        >
          <span className="w-10 h-10 flex justify-center text-qblack hover:text-white transition-all duration-300 ease-in-out items-center hover:bg-qpurple bg-qpurplelow rounded-full">
            <Compair />
          </span>
        </button>
      </div>
