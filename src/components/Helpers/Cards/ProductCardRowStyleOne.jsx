  ...
  return (
    ...
    >
      <div className="flex space-x-5 items-center w-full h-full">
        <div className="sm:w-[174] bg-qpurplelow rounded-md w-[150px] h-full overflow-hidden ">
        ...
        <div className="flex-1">
          ...
          <div className="w-full h-[48px]">
            <div
              ...
              className="w-[135px] h-[48px] pl-6 pt-3 cursor-pointer bg-qpurplelow group-hover:bg-qpurple absolute -bottom-1 -right-1  rounded transition-all duration-300 ease-in-out"
            >
      ...
      <div className="quick-access-btns flex flex-col space-y-2">
        ...
        >
          <span className="w-10 h-10 flex justify-center text-qblack hover:text-white items-center transition-all duration-300 ease-in-out hover:bg-qpurple bg-qpurplelow rounded">
        ...
        {!arWishlist ? (
          ...
          >
            <span className="w-10 h-10 flex text-qblack hover:text-white justify-center items-center transition-all duration-300 ease-in-out hover:bg-qpurple bg-qpurplelow rounded">
          ...
          >
            <span className="w-10 h-10 flex justify-center items-center bg-qpurplelow rounded">
              <ThinLove fill={true} />
            </span>
          </button>
        )}
        ...
        >
          <span className="w-10 h-10 flex justify-center text-qblack hover:text-white transition-all duration-300 ease-in-out items-center hover:bg-qpurple bg-qpurplelow rounded">
            <Compair />
          </span>
        </button>
      </div>
