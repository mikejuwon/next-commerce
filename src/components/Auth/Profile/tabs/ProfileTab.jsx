...
export default function ProfileTab({ profileInfo, updatedProfile }) {
  ...
  const updateProfile = async (handler) => {
    if (auth()) {
  ...
  return (
    <>
      {profileInfo && (
        <>
          <div className="flex lg:flex-row flex-col-reverse lg:space-x-8 rtl:space-x-reverse">
            <div className="lg:w-[660px] ">
              ...
              <div className="input-item md:flex md:space-x-2.5 rtl:space-x-reverse mb-8">
                <div className="md:w-1/2 w-full  h-full mb-6 md:mb-0">
                  <div>
                ...
                <div className="md:w-1/2 w-full h-full relative">
                  ...
                  <button
                    ...
                    type="button"
                    className="w-[70px] h-[50px] bg-qpurplelow absolute left-0 top-[29px] flex justify-center items-center"
                  >
              ...
              <div className="mb-6">
                ...
                <div
                  className={`w-full h-[50px] border border-qpurplelow px-5 flex justify-between items-center rounded mb-2 ${
                ...
                <div className="flex xl:justify-center justify-start">
                  <div className="relative">
                    ...
                    <div
                      ...
                      className="w-[32px] h-[32px] absolute bottom-7 right-0 bg-qpurple rounded-full cursor-pointer"
                    >
                      <svg
                        width="32"
                        height="32"
          ...
          <div className="action-area flex space-x-4 items-center">
            ...
            <DefaultUser.Consumer>
              {({ handler }) => (
                <button
                  onClick={() => updateProfile(handler)}
                  type="button"
                  className="w-[164px] h-[50px] transition-common bg-qpurple hover:bg-qpurplelow border border-transparent hover:border-qpurple hover:text-qpurple text-white  rounded text-white text-sm"
                >
                  {langCntnt && langCntnt.Update_Profile}
                </button>
              )}
