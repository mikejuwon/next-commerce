    ...
    <>
      <div className="relative w-full overflow-x-auto sm:rounded-lg">
        <table className="w-full text-sm text-left text-qgray dark:text-gray-400">
          <tbody>
            {/* table heading */}
            <tr className="text-base text-qgray whitespace-nowrap px-2 border-b border-qpurplelow ">
            ...
            {orders &&
              orders.length > 0 &&
              orders.map((item, i) => (
                <tr key={i} className="bg-white border-b border-qpurplelow">
                  ...
                  <td className="py-4 flex justify-center">
                    <div className="flex space-x-2 items-center">
                      <Link href={`/order/${item.order_id}`}>
                        <div className="w-[116px] h-[46px] transition-common bg-qpurple hover:bg-qpurplelow hover:text-qpurple border border-transparent hover:border-qpurple text-white  font-bold flex justify-center items-center cursor-pointer rounded">
