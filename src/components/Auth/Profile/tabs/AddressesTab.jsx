        ...
        .then(async (res) => {
          if (res.data) {
            ...
            if (res.data.address) {
              ...
              if (
                res.data.address.type === "home" ||
                res.data.address.type === "1"
              ) {
                setHome(true);
              } else if (
                res.data.address.type === "office" ||
                res.data.address.type === "0"
              ) {
                setOffice(true);
              } else {
                return false;
          ...
          <div className="form-area">
            <form>
              ...
              <div className="mb-6">
                ...
                <div
                  className={`w-full h-[50px] border px-5 flex justify-between items-center rounded border-qpurplelow mb-2 ${
              ...
              {editAdd ? (
                ...
                >
                  <div className="green-btn  rounded">
                    <span className="text-sm text-white">
                      {langCntnt && langCntnt.Update_address}
                    </span>
                    {loading && (
                      <span
                        className="w-5 "
                ...
                <button
                  ...
                  className="w-full h-[50px]"
                >
                  <div className="transition-common h-full flex justify-center items-center bg-qpurple hover:bg-qpurplelow hover:text-qpurple text-white  rounded">
              ...
              >
                <div className="flex justify-between items-center">
                  <p className="title text-[22px] font-semibold">
                    {langCntnt && langCntnt.Address} #{index + 1}
                  </p>
                  <div className="flex space-x-2.5 items-center">
                    <button
                      onClick={() => editAddress(item.id)}
                      type="button"
                      className="bg-white shadow text-qpurple w-[34px] h-[34px] rounded-full flex justify-center items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                    ...
                    <button
                      ...
                      type="button"
                      className="bg-white shadow w-[34px] h-[34px] rounded-full flex justify-center items-center"
                    >
                      <svg
                        className="w-4 h-4"
                        viewBox="0 0 17 19"
                  ...
                  <table>
                    <tbody>
                      <tr className="flex mb-3">
                        <td className="text-base text-qgray w-[70px] block line-clamp-1 capitalize">
